                  ...
                  Form(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                          ...
                          label: Text('Name', style: TextStyle(color: Colors.blue, fontSize: 21, fontWeight: FontWeight.w500))),
                    ),
                  ),
                  const SizedBox(
                    height: 20,
                  ...
                  Form(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Colors.white, fontSize: 19, fontWeight: FontWeight.w500),
                          label: Text('Email', style: TextStyle(color: Colors.blue, fontSize: 21, fontWeight: FontWeight.w500))),
                    ),
                  ),
                  const SizedBox(
                    height: 50,
